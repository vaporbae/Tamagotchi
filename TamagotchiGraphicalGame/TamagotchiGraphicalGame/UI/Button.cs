...
{
    public sealed class Button : IUIControl
    {
        ...
        public Button(short X, short Y, Sprite sprite, Events.OnClick callback, bool active = false)
        {
            SetItem(X, Y, sprite, callback, active);
        }

        public Button(Coord position, Sprite sprite, Events.OnClick callback, bool active = false)
        {
